...
quote_pages = ['https://www.bman.ro/products/camasa-bleu-bman741',
               'https://www.bman.ro/products/camasa-alba-cu-manseta-dubla-bman724']
...
with open('bman.csv', 'a') as csv_file:
